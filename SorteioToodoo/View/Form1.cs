...
namespace SorteioToodoo
{
    public partial class Form1 : Form
    {
        ...
        public static string TOPGEAR = "TopGear1.wav";
        public static string FOGOS = "fogos.wav";

        private Sorteio Sorteio { get; set; }
        public  SoundPlayer Fogos { get; set; }
        public SoundPlayer SomMenu { get; set; }

        public Form1()
        {
            InitializeComponent();

            Fogos = new SoundPlayer(Path.GetFullPath(FOGOS));
            SomMenu = new SoundPlayer(Path.GetFullPath(TOPGEAR));
        ...
        private void listSorteio_SelectedIndexChanged(object sender, EventArgs e)
        {
